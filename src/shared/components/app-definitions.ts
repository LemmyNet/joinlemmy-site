...
const BLORP: AppDetails = {
  ...
  icon: "/static/assets/apps/blorp.png",
  banner: "/static/assets/apps/blorp_screen.webp",
  links: {
    appleinc:
...
const ECHO: AppDetails = {
  ...
  icon: "/static/assets/apps/echo.webp",
  banner: "/static/assets/apps/echo_screen.webp",
  links: {
...
const VOYAGER: AppDetails = {
  ...
  icon: "/static/assets/apps/voyager.png",
  banner: "/static/assets/apps/voyager_screen.webp",
  links: {
    appleinc:
...
const THUNDER: AppDetails = {
  ...
  icon: "/static/assets/apps/thunder_logo.webp",
  banner: "/static/assets/apps/thunder_screen.webp",
  links: {
...
const JERBOA: AppDetails = {
  ...
  icon: "/static/assets/apps/jerboa.svg",
  banner: "/static/assets/apps/jerboa_screen.webp",
  links: {
...
const ETERNITY: AppDetails = {
  ...
  icon: "/static/assets/apps/eternity_icon.webp",
  banner: "/static/assets/apps/eternity_screen.webp",
  links: {
...
const BOOST: AppDetails = {
  ...
  icon: "/static/assets/apps/boost_icon.webp",
  banner: "/static/assets/apps/boost_screen.webp",
  links: {
    googleplay:
...
const SYNC: AppDetails = {
  ...
  icon: "/static/assets/apps/sync_icon.webp",
  banner: "/static/assets/apps/sync_screen.webp",
  links: {
    googleplay:
...
const MLEM: AppDetails = {
  ...
  icon: "/static/assets/apps/mlem.png",
  banner: "/static/assets/apps/mlem_screen.webp",
  links: {
...
const LEMMY_UI: AppDetails = {
  ...
  banner: "/static/assets/apps/lemmy_ui.webp",
  links: {
...
const PHOTON: AppDetails = {
  ...
  banner: "/static/assets/apps/photon.webp",
  icon: "/static/assets/apps/photon-logo.svg",
  links: {
    web: "https://phtn.app/",
...
const ALEXANDRITE: AppDetails = {
  ...
  icon: "/static/assets/apps/alexandrite_logo.svg",
  banner: "/static/assets/apps/alexandrite_screen.webp",
  links: {
...
const MLMYM: AppDetails = {
  ...
  banner: "/static/assets/apps/mlmym_screen.webp",
  links: {
...
const NEONMODEM: AppDetails = {
  ...
  banner: "/static/assets/apps/neonmodem.webp",
  links: {
...
const SUMMIT: AppDetails = {
  ...
  icon: "/static/assets/apps/summit_logo.svg",
  banner: "/static/assets/apps/summit_screen.webp",
  links: {
    googleplay:
...
const ARCTIC: AppDetails = {
  ...
  icon: "/static/assets/apps/arctic_icon.webp",
  banner: "/static/assets/apps/arctic_screen.webp",
  links: {

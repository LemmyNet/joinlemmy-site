...
const BLORP: AppDetails = {
  ...
  icon: "/static/assets/images/apps/blorp.png",
  banner: "/static/assets/images/apps/blorp_screen.webp",
  links: {
    appleinc:
...
const ECHO: AppDetails = {
  ...
  icon: "/static/assets/images/apps/echo.webp",
  banner: "/static/assets/images/apps/echo_screen.webp",
  links: {
...
const VOYAGER: AppDetails = {
  ...
  icon: "/static/assets/images/apps/voyager.png",
  banner: "/static/assets/images/apps/voyager_screen.webp",
  links: {
    appleinc:
...
const THUNDER: AppDetails = {
  ...
  icon: "/static/assets/images/apps/thunder_logo.webp",
  banner: "/static/assets/images/apps/thunder_screen.webp",
  links: {
...
const JERBOA: AppDetails = {
  ...
  icon: "/static/assets/images/apps/jerboa.svg",
  banner: "/static/assets/images/apps/jerboa_screen.webp",
  links: {
...
const ETERNITY: AppDetails = {
  ...
  icon: "/static/assets/images/apps/eternity_icon.webp",
  banner: "/static/assets/images/apps/eternity_screen.webp",
  links: {
...
const BOOST: AppDetails = {
  ...
  icon: "/static/assets/images/apps/boost_icon.webp",
  banner: "/static/assets/images/apps/boost_screen.webp",
  links: {
    googleplay:
...
const SYNC: AppDetails = {
  ...
  icon: "/static/assets/images/apps/sync_icon.webp",
  banner: "/static/assets/images/apps/sync_screen.webp",
  links: {
    googleplay:
...
const MLEM: AppDetails = {
  ...
  icon: "/static/assets/images/apps/mlem.png",
  banner: "/static/assets/images/apps/mlem_screen.webp",
  links: {
...
const LEMMY_UI: AppDetails = {
  ...
  banner: "/static/assets/images/apps/lemmy_ui.webp",
  links: {
...
const PHOTON: AppDetails = {
  ...
  banner: "/static/assets/images/apps/photon.webp",
  icon: "/static/assets/images/apps/photon-logo.svg",
  links: {
    web: "https://phtn.app/",
...
const ALEXANDRITE: AppDetails = {
  ...
  icon: "/static/assets/images/apps/alexandrite_logo.svg",
  banner: "/static/assets/images/apps/alexandrite_screen.webp",
  links: {
...
const MLMYM: AppDetails = {
  ...
  banner: "/static/assets/images/apps/mlmym_screen.webp",
  links: {
...
const NEONMODEM: AppDetails = {
  ...
  banner: "/static/assets/images/apps/neonmodem.webp",
  links: {
...
const SUMMIT: AppDetails = {
  ...
  icon: "/static/assets/images/apps/summit_logo.svg",
  banner: "/static/assets/images/apps/summit_screen.webp",
  links: {
    googleplay:
...
const ARCTIC: AppDetails = {
  ...
  icon: "/static/assets/images/apps/arctic_icon.webp",
  banner: "/static/assets/images/apps/arctic_screen.webp",
  links: {
